...
public class CheackoutPage extends PageObject {
    ...
    public static final Target CANCEL_BTN= Target.the("cancel btn ").located(By.xpath("//*[@id='cancel']"));
    public static final Target PRODUCT_NAME_OVERVIEW= Target.the("product name overview").located(By.className("inventory_item_name"));
    ...
    public static final Target ITEM_TOTAL_OVERVIEW= Target.the("item total overview").located(By.className("summary_subtotal_label"));
    ...
    public static final Target FINISH_BTN= Target.the("finish btn ").located(By.id("finish"));
